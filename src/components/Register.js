...
const Register = () => {
    ...
    const handleSubmit = (event) => {
        event.preventDefault();//eta reload hote de na
        const form = event.target;
        const name = form.name.value;// ekhane emaill field , name field , password field k capture kore
    ...
    return (
        <section className="bg-black dark:bg-gray-900 w-3/5 mx-auto">
